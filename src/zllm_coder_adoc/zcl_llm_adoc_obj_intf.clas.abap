"! <p class="shorttext synchronized" lang="en">Interface specific documentation</p>
CLASS zcl_llm_adoc_obj_intf DEFINITION
  PUBLIC
  FINAL
...
CLASS zcl_llm_adoc_obj_intf IMPLEMENTATION.
  METHOD zif_llm_adoc_object~document.
    ...
    " Combine all source code objects.
    ...
    " Overview
    DATA(prompt) = zcl_llm_adoc_prompts=>interface_doc.
    prompt = |{ source_code }\nInstructions:\n{ prompt }|.
    ...
    documentation-title = |Interface { obj_name }|.
